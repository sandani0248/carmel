...
<body>
	...
	<?php
		...
		if(isset($_SERVER['REQUEST_URI'])) {
			...
			setcookie('source_url', $source_URL, time() + (86400 * 30), "/"); // cookie to expire in 30 days
		}
		else {
			$source_URL="";
		}
				...
				<div class="col-xs-12">
					...
					<div class="dropdown" id="main-menu-dropdown">
						...
						<ul class="dropdown-menu" aria-labelledby="dLabel">
							...
							<li class="floorPlans-link"><a href="../floor-plans.php">Floor Plans</a></li>
							...
							<li class="contactUs-link"><a href="../contact-us.php">Contact Us</a></li>
						</ul>
					</div>
