			...
			<div class="row">
				<div class="col-sm-6 clearfix">
					<ul class="footer-links">
						...
						<li><a href="../contact-us.php">Schedule Site Visit</a></li>
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							<form id="salesforce" class="ajaxForm" action="https://webto.salesforce.com/servlet/servlet.WebToLead?encoding=UTF-8" method="POST">
								...
								<!--  <input type="hidden" name="debugEmail" value="incor.purpl@gmail.com">-->
								<!--  ----------------------------------------------------------------------  -->
								...
								if(isset($_COOKIE["Secondary_Source"])) {echo $_COOKIE["Secondary_Source"];}elseif(isset($qsarray["Secondary_Source"])){echo $qsarray["Secondary_Source"];}else{ echo "";} ?>" />
								...
								<input id="00N6F00000WdFSb" name="00N6F00000WdFSb" title="source URL" type="hidden" value="<?php if(isset($_COOKIE["source_url"])) {echo $_COOKIE['source_url'];}elseif(isset($qsarray["source_url"])){echo $qsarray["source_url"];}else{ echo "";} ?>" />
	...
	<script>
		  $("body").on('submit', '#rsvpForm', function(e) {
		...
		var totalattendee=$("#totalattendee").val();
		...
		$.ajax({
            ...
            url: "./rsvpProcess.php",
            dataType: "json",
            data: {name:name, email:email, mobile:mobile, attendance:attendance,totalattendee:totalattendee,attending:attending},
            success : function(data){
                if (data.code == "200"){
					$("#rsvpForm").css("display","none");
					...
					$("#rsvpForm").css("display","none");
					$(".display-warning").html("<ul>"+data.msg+"</ul>");
                    $(".display-warning").css("display","block");
				}
				else {
