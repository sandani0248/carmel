			...
			<div class="row">
				<div class="col-sm-6 clearfix">
					<ul class="footer-links">
						<li><a href="https://carmelheights.in//about-us.html">About the Developer</a></li>
						<li><a href="https://carmelheights.in//amenities.html">Amenities</a></li>
						<li><a href="https://carmelheights.in//brochure.html">Download Brochure</a></li>
						<li><a href="https://carmelheights.in//contact-us.html">Schedule Site Visit</a></li>
				...
				<div class="col-sm-6">
					<div class="oceanus-box">
						<a href="http://incor.in/" target="_blank">
							<img src="<?php echo get_template_directory_uri();?>/img/oceanus.png" width="260" alt="Oceanus">
						</a>
					</div>
				</div>
			</div>
	...
	<!-- Salesforce Enquiry Modal -->
			...
			<a href="#" id="book-now-button" data-toggle="modal" data-target="#contactModal" style="outline: none !important;">
				<img src="<?php echo get_template_directory_uri();?>/img/download-brochure.png" alt="Download Brochure" title="Download Brochure">
			</a>
...
href="tel:8884255557" style="outline: none !important;">
	...
	<script src="<?php echo get_template_directory_uri();?>/js/vendor/intlTelInput.min.js"></script>
	...
	<script src="<?php echo get_template_directory_uri();?>/js/main.js?v=<?php echo $cache_bust; ?>"></script>
