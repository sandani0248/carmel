...
<head>
	...
	<link rel="stylesheet" href="<?php echo get_template_directory_uri();?>/css/style.css?v=<?php echo $cache_bust; ?>">
				...
				<div class="col-xs-12">
					...
					<div class="dropdown" id="main-menu-dropdown">
						...
						<ul class="dropdown-menu" aria-labelledby="dLabel">
							<li class="home-link"><a href="https://carmelheights.in/index.html">Home</a></li>
							<li class="floorPlans-link"><a href="https://carmelheights.in/floor-plans.html">Floor Plans</a></li>
							<li class="amenities-link"><a href="https://carmelheights.in/amenities.html">Amenities</a></li>
							<li class="location-link"><a href="https://carmelheights.in/location.html">Location</a></li>
							<li class="aboutUs-link"><a href="https://carmelheights.in/about-us.html">About Us</a></li>
							<li class="contactUs-link"><a href="https://carmelheights.in/contact-us.html">Contact Us</a></li>
						</ul>
					</div>
					
					<a href="./index.php" class="header-logo" title="Carmel Heights">
						<img src="<?php echo get_template_directory_uri();?>/img/logo-carmel-heights.jpg" alt="Carmel Heights Logo">
					</a>
